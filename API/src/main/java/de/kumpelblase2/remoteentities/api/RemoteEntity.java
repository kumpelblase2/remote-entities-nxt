...
public interface RemoteEntity extends Nameable, InventoryAttached, Unloadable
{
	/**
	 ...
	 * @see de.kumpelblase2.remoteentities.api.RemoteEntity#getSound(EntitySound, String)
	 *
	 ...
	 * @see de.kumpelblase2.remoteentities.api.RemoteEntity#hasSound(EntitySound, String)
	 *
	 * @param inType    The type of the sound
