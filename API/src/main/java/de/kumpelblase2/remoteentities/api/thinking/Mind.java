...
public class Mind
{
	 ...
	 * @see #addMovementDesire(de.kumpelblase2.remoteentities.api.thinking.Desire, int)
	 */
	 ...
	 *
	 * @param inDesires		Array of DesireItems containing the desire and it's priority
	 * @see #addTargetingDesire(de.kumpelblase2.remoteentities.api.thinking.Desire, int)
	 */
