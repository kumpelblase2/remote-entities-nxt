...
public class CreateEntityContext
{
	 ...
	 * @throws de.kumpelblase2.remoteentities.exceptions.NoTypeException	When no type is specified
	 * @throws de.kumpelblase2.remoteentities.exceptions.NoNameException	When no name is specified while trying to spawn a named entity
